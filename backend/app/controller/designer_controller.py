...
from app.schema.designer_schema import DesignerRead, DesignerCreate, DesignerUpdate
...
def update_designer(designer_id: int, payload: DesignerUpdate, db: Session = Depends(get_db)):
    svc = DesignerService(db)
    try:
